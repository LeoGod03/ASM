...
public class CantidadesDao {
    ...
    public void eliminar(Producto producto, Connection conexion){ // recibe el producto y la conexión
        String comandoSQL;
        comandoSQL = "DELETE FROM control_cantidades WHERE id_producto like '"+producto.getId()+"';"; // comando para hacer el delete
	...
	String comandoSQL = "SELECT * FROM  control_cantidades WHERE id_producto like '"+producto.getId()+"'"; // comando SQL para la busqueda
	PreparedStatement comando;
	try {
